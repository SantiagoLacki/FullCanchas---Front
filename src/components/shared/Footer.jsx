    ...
    <footer className="footer">
      <div className="footer-middle container-fluid">
        <div className="footer-col footer-left">
          <img src="logo_fullCancha_png.png" alt="FullCancha Logo" className="footer-logo" />
        </div>
        ...
        <div className="footer-col footer-center pt-4 text-center">
          ...
          <p>
            <i className="bi bi-geo-alt fs-4 text-white"></i> Gral. José María Paz 1544, San Miguel de Tucumán, Tucumán
          </p>
        </div>
