    ...
    if (titulo === "Modificar Reserva") {
      ...
      if (respuesta.status === 200) {
        ...
        if (reservaBuscada === undefined) {
          ...
          const fechaFormateada = new Date(reservaBuscada.dia).toISOString().split("T")[0];
          ...
          <div className="d-flex justify-content-center">
            <Form className="my-4 w-75" onSubmit={handleSubmit(onSubmit)}>
              <Form.Group className="mb-4" controlId="formCliente">
                ...
                <Form.Text className="text-danger">{errors.idUsuario?.message}</Form.Text>
              </Form.Group>
              ...
              <Form.Group className="mb-4" controlId="formDia">
                ...
                />
                <Form.Text className="text-danger">{errors.dia?.message}</Form.Text>
              </Form.Group>
